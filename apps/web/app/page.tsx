      ...
      <nav className="fixed w-full bg-gray-900/80 backdrop-blur-sm z-50 border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4 md:gap-8">
              <Link
                href="#"
          ...
          <div className="lg:min-h-screen lg:flex lg:items-center lg:gap-8">
            <div className="lg:w-1/2 lg:flex lg:flex-col lg:justify-center">
              ...
              <p className="text-xl text-gray-400 mb-8">
                A powerful and intuitive whiteboard that helps you bring your
                ideas to life. Perfect for diagrams, sketches, and collaborative
                brainstorming.
              </p>
              <div className="flex space-x-4">
                <Link href={"/"}>
                  <button className="bg-blue-500 text-white px-6 py-3 rounded-lg hover:bg-blue-600 hover:gap-2 transition-all flex items-center justify-center">
                    Start Drawing Now
                    <ArrowRight className="ml-2 w-5 h-5" />
                  </button>
                </Link>
                <Link href={"https://github.com/binay-das/drawit.git"}>
          ...
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl p-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
                ...
                drawings with DrawCanvas. No sign-up required - start drawing
                right away!
              </p>
